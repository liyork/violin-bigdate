...
public class Curse extends org.apache.avro.specific.SpecificExceptionBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"error\",\"name\":\"Curse\",\"namespace\":\"com.wolf.test.hadoop.avro.generateclass\",\"fields\":[{\"name\":\"message\",\"type\":\"string\"}]}");
  ...
  public static Curse.Builder newBuilder() {
    return new Curse.Builder();
  }
  
  /** Creates a new Curse RecordBuilder by copying an existing Builder */
  public static Curse.Builder newBuilder(Curse.Builder other) {
    return new Curse.Builder(other);
  }
  
  /** Creates a new Curse RecordBuilder by copying an existing Curse instance */
  public static Curse.Builder newBuilder(Curse other) {
    return new Curse.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificErrorBuilderBase<Curse>
    ...
    private Builder(Curse.Builder other) {
      super(other);
    ...
    @Override
    public Curse.Builder setValue(Object value) {
      super.setValue(value);
      return this;
    }
    
    @Override
    public Curse.Builder clearValue() {
      super.clearValue();
      return this;
    }

    @Override
    public Curse.Builder setCause(Throwable cause) {
      super.setCause(cause);
      return this;
    }
    
    @Override
    public Curse.Builder clearCause() {
      super.clearCause();
      return this;
    }
    ...
    /** Sets the value of the 'message$' field */
    public Curse.Builder setMessage$(java.lang.CharSequence value) {
    ...
    public Curse.Builder clearMessage$() {
      message$ = null;
